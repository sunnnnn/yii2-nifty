...
class Tiny extends InputWidget{
     ...
     * @var string
     */
    public $_theme = 'silver';
    /**
     * @var string
     */
    public $_fontsize = '11px 12px 13px 14px 16px 18px 20px 24px 36px 48px';
    /**
     * 移动端配置
     * @var null
     */
     ...
     * @var string
     */
    public $_menu = 'file edit insert view format table tools';
    /**
     * 插件
     * @var string
     */
    public $_plugins = 'hr table link code fullscreen image media imagetools preview searchreplace print lists advlist';
    /**
     * 工具栏
     * @var string
     */
    public $_toolbar = 'fontsizeselect bold italic | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | table link image media | fullscreen';
    /**
     * @var bool
     */
    ...
    public function renderAsset(){
        ...
        if($this->_pure === true){
            ...
            $options = [
                ...
                'fontsize_formats'  => $this->_fontsize,
